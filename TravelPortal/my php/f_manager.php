...
if ($sta == 'Approved by Finance Manager' or $sta == 'Rejected by Finance Manager') {
...
if ($sta == 'Submitted to Finance Manager' or $sta == 'Request for Infromation by Finance Manager') {
...
<td><?php echo $row['status']?></td>
<td>
<a href="display_f_manage.php?id=<?= $row['id']?>">Edit<input type="hidden" name="edit" value="Edit"/></a></td>
</tr> 
<?php $num++;  } }?>
