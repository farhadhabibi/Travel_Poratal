...
if ($sta == 'Approved by Finanace Manager' or $sta == 'Approved by Manager' or $sta == 'Rejected by Manager' or $sta == 'Submitted to Finance Manager' or $sta == 'Rejected by Finance Manager' or $sta == 'Request for Infromation by Finance Manager') {
...
<td>
<a href="manager_close.php?id=<?= $row['id']?>">Edit<input type="hidden" name="edit" value="Edit"/></a></td>
</tr> 
<?php $num++;  } }?>
<?php
$sql = "SELECT * FROM $tbl_tour;";
...
if ($sta == 'Submitted to Manager' or $sta == 'Request for Infromation by Manager') {
...
<td><?php echo $row['status']?></td>
<td>
<a href="display_manager.php?id=<?= $row['id']?>">Edit<input type="hidden" name="edit" value="Edit"/></a></td>
</tr> 
<?php $num++;  } }?>
